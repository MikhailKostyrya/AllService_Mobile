...
abstract class $VerificationCodeRequestCopyWith<$Res> {
  factory $VerificationCodeRequestCopyWith(VerificationCodeRequest value,
...
class __$$VerificationCodeRequestImplCopyWithImpl<$Res>
    extends _$VerificationCodeRequestCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_$VerificationCodeRequestImpl(
      email: null == email
          ? _value.email
          : email // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$VerificationCodeRequestImpl implements _VerificationCodeRequest {
  const _$VerificationCodeRequestImpl(
  ...
  @override
  String toString() {
    return 'VerificationCodeRequest(email: $email, code: $code)';
  }
  ...
  _$$VerificationCodeRequestImplCopyWith<_$VerificationCodeRequestImpl>
      get copyWith => __$$VerificationCodeRequestImplCopyWithImpl<
          _$VerificationCodeRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$VerificationCodeRequestImplToJson(
      this,
    );
  }
}
...
abstract class _VerificationCodeRequest implements VerificationCodeRequest {
  const factory _VerificationCodeRequest(
      {required final String email,
      required final String code}) = _$VerificationCodeRequestImpl;
